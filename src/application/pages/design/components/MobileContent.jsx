                ...
                <div className="mobileContent">
                    ...
                    <div className="page-one">
                        ...
                        <figure className="img-item">
                            <svg
                                viewBox="65 100 80 80"
                                width="100%"
                                height="300px"
                            >
                                <path
                                    className="design-icon-mobile"
                                    d="M128.7,108.1l-4.8,3.6l-4.8,11.2h-3.9l-1.5-3.3h1c1.8,0,3.3-1.5,3.3-3.3V113h1.6v-4.9h-4.9
                    ...
                    <div className="footer">
                        <div className="footer-info">
                            ...
                            <div className="smart-footer-txt">
                                SMART has received funding from the European
                                Union’s Horizon 2020 research and innovation
                                programme under grant agreement No 693642. The
                                contents of this website are the sole
                                responsibility of the SMART project and do not
