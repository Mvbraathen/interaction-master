...
class MobileContent extends React.Component {
  ...
  render() {
    ...
    if(this.state.environmental) {
      content = (
        <div>
          <div className="selected-info"> On this page you can learn more about <strong>environmental impacts</strong> within the use phase of the mobile lifecycle.</div>
    ...
    if(this.state.social) {
      content = (
        <div>
          <div className="selected-info"> On this page you can learn more about <strong>social impacts</strong> within the use phase of the mobile lifecycle.</div>
    ...
    return (
      <div className="mobilePage">
        ...
        <div className="mobileContent">
          <div className="mobile-header"> Use </div>
