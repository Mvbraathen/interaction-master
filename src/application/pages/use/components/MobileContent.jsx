            ...
            content = (
                <div className="mobile-content-margin">
                    <h1 
                        ...
                        style={{color: '#EB0000', paddingTop: '0px', paddingBottom: '0px'}}> 
                        The use phase 
                    </h1>
        ...
        if(this.state.environmental) {
            content = (
                <div className="mobile-content-margin">
                    ...
                    />
                    <div className="h1-impact-style environmental-responsive" style={{color: '#EB0000'}}> 
            ...
            content = (
                <div className="mobile-content-margin">
                    <ImpactSelection
                        ...
                        default = {this.handleDefaultClick} 
                    />
                    <div className="h1-impact-style" style={{color: '#EB0000'}}> 
                        Social impacts
                    </div>
