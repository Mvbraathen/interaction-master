      ...
      info = (
        <div className="right-half-flex-container">
          <div
            ...
            onClick={() => this.setState({ Childlabour: false })}
          >
    ...
    if (this.state.Discrimination) {
      info = (
        <div className="right-half-flex-container">
          <div
            className="active-social-info-element"
            onClick={() => this.setState({ Discrimination: false })}
          >
            <div className="active-info-box-content">
              {" "}
              <Discrimination />{" "}
    ...
    if (this.state.Foodinsecurity) {
      info = (
        <div className="right-half-flex-container">
          <div
            className="active-social-info-element"
            onClick={() => this.setState({ Foodinsecurity: false })}
          >
            <div className="active-info-box-content">
              {" "}
              <FoodInsecurity />{" "}
    ...
    if (this.state.Genderinequality) {
      info = (
        <div className="right-half-flex-container">
          <div
            className="active-social-info-element"
            onClick={() => this.setState({ Genderinequality: false })}
          >
            <div className="active-info-box-content">
              {" "}
              <GenderInequality />{" "}
    ...
    if (this.state.Humantoxicity) {
      info = (
        <div className="right-half-flex-container">
          <div
            className="active-social-info-element"
            onClick={() => this.setState({ Humantoxicity: false })}
          >
            <div className="active-info-box-content">
              {" "}
              <HumanToxicity />{" "}
    ...
    if (this.state.Livinginslums) {
      info = (
        <div className="right-half-flex-container">
          <div
            className="active-social-info-element"
            onClick={() => this.setState({ Livinginslums: false })}
          >
            <div className="active-info-box-content">
              {" "}
              <LivingInSlums />{" "}
    ...
    if (this.state.Marginalisation) {
      info = (
        <div className="right-half-flex-container">
          <div
            className="active-social-info-element"
            onClick={() => this.setState({ Marginalisation: false })}
          >
            <div className="active-info-box-content">
              {" "}
              <Marginalisation />{" "}
    ...
    if (this.state.Polluteddrinkingwater) {
      info = (
        <div className="right-half-flex-container">
          <div
            className="active-social-info-element"
            onClick={() => this.setState({ Polluteddrinkingwater: false })}
          >
            <div className="active-info-box-content">
              {" "}
    ...
    if (this.state.Precariouswork) {
      info = (
        <div className="right-half-flex-container">
          <div
            className="active-social-info-element"
            onClick={() => this.setState({ Precariouswork: false })}
          >
            <div className="active-info-box-content">
              {" "}
              <PrecariousWork />{" "}
    ...
    if (this.state.Violentconflict) {
      info = (
        <div className="right-half-flex-container">
          <div
            className="active-social-info-element"
            onClick={() => this.setState({ Violentconflict: false })}
          >
            <div className="active-info-box-content">
              {" "}
              <ViolentConflict />{" "}
