            ...
            <div id="home-page">
                    ...
                    <a tabIndex="-1" href="https://www.smart.uio.no">
                        <div tabIndex="0" className="desktop-bookmark">
                            <div className="hidden-bookmark-text">
                                This website is made in collaboration with the
                                EU Horizon 2020 funded <strong>SMART</strong>{" "}
                                project.
                            </div>
                            <img
                ...
                <div className="split right-half">
                    <div className="hehe-container">
                        <div className="introTxt">
                            ...
                            <br /> If you want to learn more about the{" "}
                            <div className="color-some-text">
                                Mobile Lifecycle
                            </div>
                            , please interact with the circular menu to your
                            left.
                        </div>
                    </div>
                </div>
                ...
                <div className="desktop-footer">
                    ...
                    <div className="desktop-footer-txt">
                        SMART has received funding from the European Union’s
                        Horizon 2020 research and innovation programme under
                        grant agreement No 693642. The contents of this website
                        are the sole responsibility of the SMART project and do
